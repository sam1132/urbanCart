  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center h-[100vh] m-7 px-4 md:px-6 lg:px-8 my-10 ">
        ...
        <form className="flex max-w-md flex-col gap-4 shadow-lg px-10 w-[600px]" onSubmit={handleSubmit}>
          <div>
          ...
          <Button type="submit"  className="text-white bg-blue-600 hover:scale-105 transition-all delay-150 my-2 font-bold">Submit</Button>
        </form>
      </div>
    </>
  );
